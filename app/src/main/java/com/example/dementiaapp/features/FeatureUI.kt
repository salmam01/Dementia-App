package com.example.dementiaapp.features
...
fun Feature.toFeatureUI(): FeatureUI {
    return when (this.type) {
        FeatureType.CALENDAR -> AllFeatureUI.Calendar
        FeatureType.DIARY -> AllFeatureUI.Diary
        FeatureType.MY_FAMILY -> AllFeatureUI.MyFamily
        FeatureType.MEDICATION -> AllFeatureUI.Medication
        FeatureType.REMINDERS -> AllFeatureUI.Reminders
        FeatureType.CALL -> AllFeatureUI.Call
        FeatureType.LOGS -> AllFeatureUI.Logs
        FeatureType.PROFILE -> AllFeatureUI.Profile
    }
}